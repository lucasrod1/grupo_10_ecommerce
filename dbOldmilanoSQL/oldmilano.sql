...
CREATE TABLE IF NOT EXISTS `product_order` (
  ...
  `products_color_id` int(11) DEFAULT NULL,
  `products_sizes_id` int(11) DEFAULT NULL,
  `active_flag` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_order_FK` (`products_id`),
  KEY `product_order_FK_1` (`products_color_id`),
  KEY `product_order_FK_2` (`products_sizes_id`),
  CONSTRAINT `product_order_FK` FOREIGN KEY (`products_id`) REFERENCES `products` (`id`),
  CONSTRAINT `product_order_FK_1` FOREIGN KEY (`products_color_id`) REFERENCES `product_colors` (`id`),
  CONSTRAINT `product_order_FK_2` FOREIGN KEY (`products_sizes_id`) REFERENCES `product_sizes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
